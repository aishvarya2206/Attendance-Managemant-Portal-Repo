    ...
    public partial class InitialDbCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ValidWiFis", x => x.ID);
                });
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "ID", "Name" },
                values: new object[] { 1, "TestDepartment" });

            migrationBuilder.InsertData(
                table: "ValidWiFis",
                columns: new[] { "ID", "Location", "SSID" },
                values: new object[] { 1, "Gurgaon", "Raj-5G" });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "ID", "Code", "DepartmentId", "FullName", "UserName" },
                values: new object[,]
                {
                    { 1, "DEP123", 1, "TestEmployee1", "TestName1" },
                    { 2, "DEP124", 1, "TestEmployee2", "TestName2" }
                });
